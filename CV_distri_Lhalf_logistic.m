function [Opt,Mse]=CV_distri_Lhalf_logistic(X,Y,Lambda,J,beta_path,beta_int,beta_zero)
    ...
    for l=1:length(Lambda)
        ...
        for i=1:K
            ...
            [b history] = distr_lhalf_logreg(X_train, Y_train, lambda, J, 1.0, 1.0);
